...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await contactService.sendContactMessage(formValues);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-indigo-200">123 Music Street, Harmony City, HC 12345</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-indigo-200">info@instrumenthaven.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-indigo-200">Monday - Friday: 9AM - 5PM</p>
                    <p className="text-indigo-200">Saturday: 10AM - 4PM</p>
                    <p className="text-indigo-200">Sunday: Closed</p>
                  </div>
                </div>
              </div>
        ...
        {/* Google Map */}
        <div className="mt-8 rounded-lg overflow-hidden h-80 bg-gray-200">
