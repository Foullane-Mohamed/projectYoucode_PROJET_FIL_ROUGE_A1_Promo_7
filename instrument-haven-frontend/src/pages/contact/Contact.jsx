    ...
    >
      ...
      <Box
        sx={{
          ...
          borderRadius: "50%",
          background:
            "linear-gradient(135deg, rgba(255, 43, 82, 0.08), rgba(255, 43, 82, 0.01))",
          top: "-50px",
          left: "-100px",
          zIndex: 0,
        }}
      ...
      <Box
        sx={{
          ...
          borderRadius: "50%",
          background:
            "linear-gradient(135deg, rgba(255, 43, 82, 0.05), rgba(255, 43, 82, 0.02))",
          bottom: "100px",
          right: "-50px",
          zIndex: 0,
        }}
        ...
        >
          ...
          <Box
            sx={{
              ...
              height: "3px",
              background:
                "linear-gradient(90deg, transparent, #FF2B52, transparent)",
              margin: "0 auto",
              mt: 3,
            }}
          />
              ...
              >
                ...
                <Box
                  sx={{
                    ...
                    mt: "auto",
                    background:
                      "linear-gradient(to bottom, rgba(0,0,0,0.005), rgba(0,0,0,0.02))",
                  }}
                >
                  <Typography
                    variant="h6"
                    gutterBottom
                    sx={{ fontWeight: 600, fontSize: "1.1rem", color: "#444" }}
                  >
                    <Box
                      component="span"
                      sx={{
              ...
              >
                ...
                >
                  ...
                  <Box sx={{ display: "flex", alignItems: "center", mt: 2 }}>
                    <LocationOn
                      sx={{ color: "#FF2B52", fontSize: 18, mr: 1 }}
                    />
                    <Typography
                      variant="body2"
                      color="text.secondary"
                ...
                >
                  ...
                  >
                    <Typography
                      sx={{ fontWeight: 700, fontSize: "20px", color: "#555" }}
                    >
                      +
                    </Typography>
                  </Box>
